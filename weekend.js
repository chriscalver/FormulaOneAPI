...
async function getRaces() {
    ...
    function timetrimFunction(t) {
        ...
        if (t2 > 12) {     //converts to 12 hr time
            t2 = t2 - 12;
        }
        t2 = t2 - 4;
    ...
    if (SprintWeekend = true) {
        ...
        const eventThreeDate = lastRaceData.MRData.RaceTable.Races[0].SecondPractice.date;
        document.getElementById("eventThreeDate").innerHTML = dateTrimFunction(eventThreeDate);
        var eventThreeTime = lastRaceData.MRData.RaceTable.Races[0].SecondPractice.time;
