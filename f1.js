...
async function getRaces() {
  ...
  const Pos1 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[0].Driver
      .familyName;
  const Pos2 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[1].Driver
      .familyName;
  const Pos3 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[2].Driver
      .familyName;
  const Pos4 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[3].Driver
      .familyName;
  const Pos5 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[4].Driver
      .familyName;
  const Pos6 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[5].Driver
      .familyName;
  const Pos7 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[6].Driver
      .familyName;
  const Pos8 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[7].Driver
      .familyName;
  const Pos9 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[8].Driver
      .familyName;
  const Pos10 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[9].Driver
      .familyName;
  ...
  const Pts1 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[0]
      .points;
  const Pts2 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[1]
      .points;
  const Pts3 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[2]
      .points;
  const Pts4 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[3]
      .points;
  const Pts5 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[4]
      .points;
  const Pts6 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[5]
      .points;
  const Pts7 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[6]
      .points;
  const Pts8 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[7]
      .points;
  const Pts9 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[8]
      .points;
  const Pts10 =
    driverData.MRData.StandingsTable.StandingsLists[0].DriverStandings[9]
      .points;
  ...
  const constPos1 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[0]
      .Constructor.name;
  const constPos2 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[1]
      .Constructor.name;
  const constPos3 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[2]
      .Constructor.name;
  const constPos4 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[3]
      .Constructor.name;
  const constPos5 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[4]
      .Constructor.name;
  const constPos6 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[5]
      .Constructor.name;
  const constPos7 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[6]
      .Constructor.name;
  const constPos8 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[7]
      .Constructor.name;
  const constPos9 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[8]
      .Constructor.name;
  const constPos10 =
    constData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings[9]
      .Constructor.name;
  ...
  const LastRacePos1 =
    lastRaceData.MRData.RaceTable.Races[0].Results[0].Driver.familyName;
  const LastRacePos2 =
    lastRaceData.MRData.RaceTable.Races[0].Results[1].Driver.familyName;
  const LastRacePos3 =
    lastRaceData.MRData.RaceTable.Races[0].Results[2].Driver.familyName;
